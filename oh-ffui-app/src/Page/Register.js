...
const endpoint = "https://oh-ffui-2023-im753hqaqa-et.a.run.app/";
...
function Register() {
  ...
  async function loadDataKota() {
    setLoadingkota(true);
    axios
      .get(kotaEndpoint, { params: { id_provinsi: selectedProvinsi } })
      .then((response) => {
  ...
  async function inputCheck() {
    ...
    await axios
      .post(endpoint + "api/users-permissions/users/check", json, {
        headers: {
                ...
                <form action="#" method="POST" className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        onChange={(e) => handleInputChange(e)}
                        className={`${
                          !usernameFlag ? "border-red-500" : "border-gray-300"
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        onChange={(e) => handleInputChange(e)}
                        className={`${
                          !emailFlag ? "border-red-500" : "border-gray-300"
                        }appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                      />
                      {!emailFlag && (
                        <p className="block text-xs mt-1 font-medium text-red-500">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        onChange={(e) => handleInputChange(e)}
                        className={`${
                          notMatch ? "border-red-500" : "border-gray-300"
                  ...
                  <div className="w-50 w-2/5">
                    ...
                    {!loading && (
                      <select
                        id="provinsi"
                        className="form-select block px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        key="0"
                        dataKey="0"
                        value={provinsi}
                        onChange={(e) => handleInputChange(e)}
                  ...
                  <div className="w-50 w-3/5">
                    ...
                    {!loadingkota && (
                      <select
                        id="kota"
                        className="form-select block block- px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        value={kota}
                        onChange={(e) => handleInputChange(e)}
                      >
                        <option key="0" value="0">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <textarea
                        ...
                        value={alamat}
                        onChange={(e) => handleInputChange(e)}
                        class="block p-2.5 w-full text-sm text-gray-900 rounded-lg border border-gray-300 shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                      ></textarea>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      >
                        {" "}
                        Data yang saya isikan adalah data yang sebenar-benarnya.{" "}
                      </label>
                    </div>
                  </div>
