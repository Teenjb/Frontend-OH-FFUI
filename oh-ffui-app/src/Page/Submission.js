                    ...
                    <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
                        ...
                        <div className="mt-8">
                            ...
                            <form action="#" method="POST" className="space-y-6">
                                ...
                                <div className="mt-1">
                                    <input id="namaProyek" name="name" type="name" autocomplete="name" required className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value={namaProyek} onChange={(e)=>(handleInputChange(e))}/>
                                </div>
                                </div>
                                
                                <div>
                                <label for="name" className="block text-sm font-medium text-gray-700"> Jenis Lomba </label>
                                <div className="mt-1">
                                    <input id="jenisLomba" name="name" type="name" autocomplete="name" required className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value={jenisLomba} onChange={(e)=>(handleInputChange(e))}/>
                                </div>
                                </div>
                                ...
                                <label htmlFor="dropzone-file" className="flex flex-col justify-center items-center w-full h-64 mb-10 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 hover:bg-gray-100">
                                        {!fileLomba && <div className="flex flex-col justify-center items-center pt-5 pb-6">
                                        ...
                                        {fileLomba && <div className="flex flex-col justify-center items-center pt-5 pb-6">
                                            <img src={fileLomba} alt="file Lomba" className="w-full h-full object-cover"/>
                                            <p className="text-xs text-gray-500 dark:text-gray-400">{fileLomba.name}</p>
                                        </div>}
